...
for x in train test ; do  #train
	...
	steps/make_mfcc.sh --cmd "$train_cmd" --nj 14 data/$x exp/make_mfcc/$x $mfccdir || exit 1;
...
utils/mkgraph.sh data/lang_test exp/tri1_${sen}_${gauss} exp/tri1_${sen}_${gauss}/graph || exit 1;
...
utils/mkgraph.sh data/lang_test exp/tri2_${sen}_${gauss} exp/tri2_${sen}_${gauss}/graph || exit 1;
fi
